...
// ErrResponse renderer type for handling all sorts of
...
// ErrValidation returns status 422 Unprocessable Entity stating validation 
...
// ErrServer returns status 500 Internal Server Error.
